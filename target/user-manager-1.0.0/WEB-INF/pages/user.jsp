    ...
    <table id="users" class="ui-widget ui-widget-content">
        ...
        <c:forEach var="user" items="${userList}">
            <tr id="tr_id_${user.id}">
                ...
                <td><s:url value="/updateForm/${user.id}" var="updateUrl"/><a href="${updateUrl}">Update</a></td>
                <td><s:url value="/delete/${user.id}" var="deleteUrl"/><a id="deletelink" href="${deleteUrl}.json">Delete</a></td>
            </tr>
        </c:forEach>
        </tbody>
    </table>
